...
{
    //hangi layerda olduðumuzu tanýmlayan fonksiyon 
    private float[] GetTextureMix(Vector3 playerPos, Terrain t)
    {
        Vector3 tPos = t.transform.position;
        TerrainData tData = t.terrainData;//arazi verilerine eþit olacak
        //oyuncularrýn arazi pozisyonuna göre  x ve z konumunu depo edeceðiz
    ...
    //buulunan deðeri dýþarý taþýmamýza yarayan kkod bloðu
